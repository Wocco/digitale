...
HD_PWD='C:/Users/Wout/Documents/School/3 digitale Elektronica/project_2_2/project_2_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log drawline.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source drawline.tcl -notrace
